...
/**
 * Ver.3.6.0：アメ1個で得られるEXP（無補正）
 * - Lv1〜Lv25になるまで（= 現在Lv 1〜24 の間）：40
 * - Lv25〜Lv30になるまで（= 現在Lv 25〜29 の間）：35
 * - Lv30以降：25
 */
 ...
 * ※Ver.3.6.0 では「同時に使用するゆめのかけらの量に変更はありません」なので
 *   各レベルの dreamShardsPerCandy をそのまま使う
 */
